...
def main():
    ...
    parser.add_argument('--csv_file', default='/data/abhidip/QG_data/CU-stroy-QA-Data/train_split.csv',
                        help='path to datasets')

    parser.add_argument('--model_name_or_path', default='/data/abhidip/QG_data/experiments/model/bart-base/',
    ...
    parser.add_argument('--output_dir', default='/data/abhidip/QG_data/experiments/model',
                        help='Path to save the model.')
    parser.add_argument('--logger_name', default='/data/abhidip/QG_data/experiments/log', help='Path to save Tensorboard log.')
    ...
    parser.add_argument('--predict_file', default='/data/abhidip/QG_data/experiments/model/predict.csv',
